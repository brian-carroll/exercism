...
var _exercism$xelm$SpaceAge$secondsPerEarthYear = ((365.25 * 24) * 60) * 60;
var _exercism$xelm$SpaceAge$ageOn = F2(
	function (planet, seconds) {
		var _p0 = planet;
		switch (_p0.ctor) {
			case 'Earth':
				return seconds / (1 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			case 'Mercury':
				return seconds / (0.2408467 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			case 'Venus':
				return seconds / (0.61519726 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			case 'Mars':
				return seconds / (1.8808158 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			case 'Jupiter':
				return seconds / (11.862615 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			case 'Saturn':
				return seconds / (29.447498 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			case 'Uranus':
				return seconds / (84.016846 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
			default:
				return seconds / (164.79132 * _exercism$xelm$SpaceAge$secondsPerEarthYear);
		}
	});
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['SpaceAge'], 'SpaceAge', typeof _exercism$xelm$SpaceAge$main === 'undefined' ? null : _exercism$xelm$SpaceAge$main);

...
under100 digits =
    ...
    in
        case (String.left 1 digits) of
            ...
            "2" ->
                "twenty" ++ (lastWord lastDigit)

            "3" ->
                "thirty" ++ (lastWord lastDigit)

            "4" ->
                "forty" ++ (lastWord lastDigit)

            "5" ->
                "fifty" ++ (lastWord lastDigit)

            "6" ->
                "sixty" ++ (lastWord lastDigit)

            "7" ->
                "seventy" ++ (lastWord lastDigit)

            "8" ->
                "eighty" ++ (lastWord lastDigit)

            "9" ->
                "ninety" ++ (lastWord lastDigit)
